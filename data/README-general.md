...
This repository contains a comprehensive, multi-centre, multi-device benchmark dataset for landmark-based fetal biometry estimation from ultrasound images.
...
The repository is organised into three **primary subsets** (as described in the paper) and one **derived multi-centre subset** for convenience:
